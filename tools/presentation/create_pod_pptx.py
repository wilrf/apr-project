...
def set_cell_text(
    cell, text, font_size=14, bold=False, color=DARK_TEXT, alignment=PP_ALIGN.LEFT
):
...
def add_table(
    slide, rows_data, left=Inches(0.8), top=Inches(2.2), col_widths=None, font_size=13
):
    ...
    for r_idx, row_data in enumerate(rows_data):
        for c_idx, cell_text in enumerate(row_data):
            ...
            bold = is_header
            set_cell_text(cell, cell_text, font_size=font_size, bold=bold, color=color)
            if is_header:
                cell.fill.solid()
...
def add_body_text(
    slide, text, top=Inches(2.0), left=Inches(0.8), width=Inches(11.5), font_size=16
):
...
def build_presentation():
    ...
    add_subheader(
        slide, "Here are the key terms that come up throughout this presentation."
    )
    add_body_text(
        slide,
        (
    ...
    run = p.add_run()
    run.text = (
        "To what extent can disagreement patterns among logistic regression, "
    ...
    add_subheader(
        slide,
        (
            "No one has used model disagreement patterns to classify NFL upsets "
    ...
    add_table(
        ...
        [
            ...
            [
                ...
                '"The Summary"',
                "46",
                "Rolling averages, differentials, market, Elo",
            ],
            [
                "XGBoost",
                '"The Details"',
                "70",
                "LR's 46 + 24 per-game lag stats (last 3 games)",
            ],
            [
                "LSTM",
                '"The Movie"',
                "14×8 + 10",
                "Raw game-by-game sequences + matchup context",
            ],
        ],
        top=Inches(3.8),
        left=Inches(0.8),
    ...
    add_table(
        ...
        [
            ...
            [
                ...
                "45.4%",
                "36.7%",
                "Strong cross-architectural signal",
            ],
            ...
            [
                ...
                "6.7%",
                "29.5%",
                "Static models agree, LSTM disagrees",
            ],
